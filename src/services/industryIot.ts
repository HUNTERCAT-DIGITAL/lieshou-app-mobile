/**
 * Mobile 物联网行业 API 层（industry-iot · 2026-09 行业版收敛回迁）.
 * 共享 api-client 的 request() 适配行业包 IndustryHttpClient（去 /api 双前缀）。
 */
import { request } from "@lieshoucloud/api-client";
import { createIotApi, type IndustryHttpClient } from "@lieshoucloud/industry-iot";
...
export const iotApi = createIotApi(http);
